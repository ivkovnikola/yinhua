...
To optimize the yinhua application for production, run:
...
[Doing API-First development]: http://www.jhipster.tech/documentation-archive/v4.8.1/doing-api-first-development/
